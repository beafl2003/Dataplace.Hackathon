...
namespace Dataplace.Imersao.Core.Tests.Domain.Orcamentos
{
    ...
    public class OrcamentoTest
    {
        ...
        public void TentarFecharOrcamentoJaFechadoRetornarException()
        {
            ...
            // act & assert
            Assert.False(orcamento.FecharOrcamento());
        }
        ...
        public void TentarReabrirOrcamentoCanceladoRetornarException()
        {
            ...
            // act & assert
            Assert.False(orcamento.ReabrirOrcamento());
        }
        ...
        public void TentarCancelarOrcamentoFechadoRetornarException()
        {
            ...
            // act & assert
            Assert.False(orcamento.CancelarOrcamento());
        }
        ...
        [Fact]
        [Trait("Orcamento", "Atribior Validade")]
        public void OrcamentoAtribuirValidaPorDataDeveRetornarDataEnumDiasValidos()
        {

            // arrange
            var orcamento = _fixture.NovoOrcamento();
            var validade = 2 ;
            var validadeData = DateTime.Now.Date.AddDays(validade);

            // act
            orcamento.DefinirValidade(validadeData);

            // assert
            Assert.NotNull(orcamento.Validade);
            Assert.Equal(validade, orcamento.Validade.Dias);
            Assert.Equal(validadeData, orcamento.Validade.Data);
            Assert.Equal(orcamento.DtOrcamento.AddDays(validade).Date, orcamento.Validade.Data);
        ...
        //[Fact]
        //[Trait("Orcamento", "Atribior Previsao de Entrega")]
        //public void OrcamentoAtribuirPrevisaoDeEntregaPorDataDeveRetornarDataEnumDiasValidos()
        //{
        ...
        //    // act
        //    orcamento.DefinirPrevisaoEntrega(validadeData);
